function compute()//function to calculate and return result.
{
    var principal = document.getElementById("principal").value;
    if (principal<=0) //validating principal input box
    {
    ...
    function updateRate() //function to display rate range
    {
